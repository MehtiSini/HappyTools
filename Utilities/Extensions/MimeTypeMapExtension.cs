...
namespace HappyTools.Utilities.Extensions
{
    ...
    /// Class MimeTypeMap.
    /// </summary>
    public static class MimeTypeMapExtension
    {
        ...
        private static IDictionary<string, string> BuildMappings()
        {
            var mappings = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) {
                ...
                {".opus", "audio/ogg"},
                {".BuyRequestedtest", "application/xml"},
        ...
        {
            return TryGetMimeType(fileNameOrExtension, out var result) ? result : DefaultMimeType;
        }
