...
namespace HappyTools.Utilities.Extensions.PersianHelper
{
    ...
    public static class FriendlyPersianDateUtils
    {
        ...
        public static List<string> GetPersianMonthsBetween(DateTime startDate, DateTime endDate)
        {
            PersianCalendar pc = new PersianCalendar();
            string[] persianMonthNames = { "فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسفند" };
            List<string> months = new List<string>();

            int startMonth = pc.GetMonth(startDate);
            int startYear = pc.GetYear(startDate);
            int endMonth = pc.GetMonth(endDate);
            int endYear = pc.GetYear(endDate);
        ...
        {
            return $"{UnicodeConstants.RleChar}{dt.toFriendlyPersianDate(comparisonBase).ToPersianNumbers()}";
        }
        ...
        public static string ToFriendlyPersianDateTextify(this DateTime dt)
        {
            ...
            return $"{UnicodeConstants.RleChar}{dt.ToIranTimeZoneDateTime().toFriendlyPersianDate(comparisonBase).ToPersianNumbers()}";
        }
        ...
        {
            return $"{UnicodeConstants.RleChar}{dt.GetDateTimeOffsetPart(dateTimeOffsetPart).toFriendlyPersianDate(comparisonBase).ToPersianNumbers()}";
        }
        ...
        public static string ToFriendlyPersianDateTextify(this DateTimeOffset dt)
        {
            ...
            return $"{UnicodeConstants.RleChar}{iranLocalTime.toFriendlyPersianDate(comparisonBase).ToPersianNumbers()}";
        }
